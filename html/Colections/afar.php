...
<body>
    ...
    <section id="product1" class="section-p1">
        <h2>Bringing Modern and Traditional Styles - Shop Now!</h2>
        ...
        <div class="container mt-4">
            ...
            <div class="pro-container">
                ...
                $category_name = 'kemiss';
                // Retrieve the product data from the database
                $result = $conn->query("SELECT * FROM Products WHERE category_name = $category_name LIMIT 8");
                if ($result) {
                    while ($row = $result->fetch_assoc()) {
